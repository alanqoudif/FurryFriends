    ...
    const sampleProducts: Product[] = [
      {
        ...
        price: 29.99,
        image: 'https://via.placeholder.com/200x200/4A90E2/FFFFFF?text=طعام+الكلاب',
        category: 'food',
        petType: 'dog',
        description: 'تغذية عالية الجودة للكلاب البالغة',
        inStock: true,
      },
      {
        id: '2',
        ...
        price: 19.99,
        image: 'https://via.placeholder.com/200x200/50C878/FFFFFF?text=فضلات+القطط',
        category: 'accessories',
        petType: 'cat',
        description: 'صندوق فضلات ذاتي التنظيف للقطط',
        inStock: true,
      },
      {
        id: '3',
        ...
        price: 15.99,
        image: 'https://via.placeholder.com/200x200/FF6B6B/FFFFFF?text=ألعاب+الحيوانات',
        category: 'toys',
        petType: 'both',
        description: 'ألعاب تفاعلية للقطط والكلاب',
        inStock: true,
      },
      {
        id: '4',
        name: 'طوق الكلاب',
        price: 12.99,
        image: 'https://via.placeholder.com/200x200/9B59B6/FFFFFF?text=طوق+الكلاب',
        category: 'accessories',
        petType: 'dog',
        description: 'طوق جلدي متين مع بطاقة هوية',
        inStock: true,
      },
      {
        id: '5',
        name: 'عمود خدش القطط',
        price: 24.99,
        image: 'https://via.placeholder.com/200x200/FF9500/FFFFFF?text=عمود+الخدش',
        category: 'accessories',
        petType: 'cat',
        description: 'عمود خدش متعدد المستويات للقطط',
        inStock: true,
      },
      {
        id: '6',
        ...
        price: 18.99,
        image: 'https://via.placeholder.com/200x200/34C759/FFFFFF?text=فيتامينات',
        category: 'health',
        petType: 'both',
        description: 'فيتامينات أساسية لصحة الحيوانات الأليفة',
        inStock: true,
      },
      {
        id: '7',
        name: 'رباط الكلاب',
        price: 8.99,
        image: 'https://via.placeholder.com/200x200/FF3B30/FFFFFF?text=رباط+الكلاب',
        category: 'accessories',
        petType: 'dog',
        description: 'رباط قابل للسحب للكلاب',
        inStock: false,
      },
      {
        id: '8',
        name: 'طعام القطط',
        price: 22.99,
        image: 'https://via.placeholder.com/200x200/5856D6/FFFFFF?text=طعام+القطط',
        category: 'food',
        petType: 'cat',
        description: 'طعام القطط الخالي من الحبوب',
        inStock: true,
      },
    ];
