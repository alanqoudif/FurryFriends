    ...
    const sampleProducts: Product[] = [
      {
        ...
        price: 29.99,
        image: require('../../assets/products/dog-food.jpg'),
        category: 'food',
        petType: 'dog',
      ...
      },
      {
        ...
        price: 19.99,
        image: require('../../assets/products/cat-litter-box.jpg'),
      ...
      },
      {
        ...
        price: 15.99,
        image: require('../../assets/products/pet-toys.jpg'),
        category: 'toys',
        petType: 'both',
      ...
      },
      {
        ...
        name: 'طوق الكلاب',
        price: 12.99,
        image: require('../../assets/products/dog-collar.jpg'),
        category: 'accessories',
        petType: 'dog',
      ...
      },
      {
        ...
        name: 'عمود خدش القطط',
        price: 24.99,
        image: require('../../assets/products/cat-scratching-post.jpg'),
        category: 'accessories',
        petType: 'cat',
      ...
      },
      {
        ...
        price: 18.99,
        image: require('../../assets/products/pet-vitamins.jpg'),
        category: 'health',
        petType: 'both',
      ...
      },
      {
        ...
        name: 'رباط الكلاب',
        price: 8.99,
        image: require('../../assets/products/dog-leash.jpg'),
        category: 'accessories',
        petType: 'dog',
      ...
      },
      {
        ...
        name: 'طعام القطط',
        price: 22.99,
        image: require('../../assets/products/cat-food.jpg'),
        category: 'food',
        petType: 'cat',
